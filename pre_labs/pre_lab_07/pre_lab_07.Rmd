...
**Answer** Nevada has the largest percent growth.
...
**Answer** 	Howard County, Maryland with a $121,160	
...
**Answer** No, their margin of error bars fall within each other.

Is the difference between Howard and everyone else significant?
**Answer** Yes, the margin of error is still well outside the margin of error of any of the other counties.
...
**Answer** None of the county estimates indicate a predicted population decrease. For the minimums between the two years Caroline County, looks as through it could have had a population decrease, but it is within the the margin of error. So, we can't say for sure. For the maximums, none of them indicated a population decrease.
...
**Answer** By opening the table and sorting by decreasing totals, I was able to look at the top 20 entries. #19 is the only household of the top 20 amounts that has an estimated median household income of less than $50,000 - with $47848.
...
**Answer** What counties do each of these zip codes fall into? Are any of these in the same county? What is the average career in this zipcode? How would this data look visualized in a margin of error graph?
```{r}
md_zips_with_acs %>%
