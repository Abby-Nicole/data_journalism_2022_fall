...
https://datawrapper.dwcdn.net/eCHui/1/
...
md_gov_county <- md_gov_county %>%
  ...
  mutate(moore_pct = ((moore/total)*100)) %>%
  arrange(desc(moore_pct))
...
From the first map we made contained the entire United States, and everything was grayed out except Maryland. It warned that several thousand counties were not being used but that is just for all the counties outside of Maryland. After I selected "Hide regions without data," the map became just a map of Maryland by county in various blue-green colors.
...
**Answer** Describe the changes from the previous map
After customizing the tooltips, the counties themselves stopped being called by their fips-code and changed rather to the county name, and the incredibly long percentages became percentages that ended in teh tenths place. Now, it's much easier to read and understand when one's mouse hovers over a county.
...
https://datawrapper.dwcdn.net/1YjAJ/1/