...
**Answer** Mistypes like using a period for abbreviations or leaving an "s" off the end
...
**Answer** Adding a comma to a name (Joe's Seafood) and removing the name being written twice (Le Diplomate)
...
**Answer** 1) We the Pizza's name is oriented 3 different ways (We the Pizza), (Pizza, We the), & (We, the Pizza). It's spread across 3 rows all back to back to back rather than just two but cleaned as "We the Pizza." 2) Cleaned the two "W. Millar" & Co" and "W. Millar & Co." into the same "W. Millar & Co." in the clean column. 3) The cleaned column removed the apostrophe in "Walter's Sports Bar." 4) There's also the combination of "Hilton Washington" and "Washington Hilton" both being classified as "Washington Hilton." It does go from 50 rows to 52 rows in this table.
...
**Answer** Not terribly. It classified two of the "Walters" variations as "Walters Sports" so that is a step up from the last code run. There are now 51 rows compared to the previous 52 and 50. It took the 3 variations of "We the Pizza" and narrowed it to 2 variations.
