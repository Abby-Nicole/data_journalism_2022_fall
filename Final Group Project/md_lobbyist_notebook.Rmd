...
```
```{r}
#As for determining how many contracts are still active, I set the "end" filter for after the day sports betting legally began in Maryland on November 03, 2020. We can see that there are 261 registration period contracts regarding gaming that are still active now that sports betting is legal in Maryland.
...
### ***New questions Derek edits 12/03:
For criminal law procedure lobbyists, are there new people among the recent registrants who haven't registered before? Have the registrants changed in other ways compared not just to the most recent period but earlier periods, too? 
